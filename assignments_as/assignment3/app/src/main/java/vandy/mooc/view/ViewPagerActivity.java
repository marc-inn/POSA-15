...
public class ViewPagerActivity extends FragmentActivity {
     ...
     */
    private static final String TAG = ViewPagerActivity.class.getCanonicalName();
    /**
     * Name of the intent action that will start this Activity.
     */
    public static String ACTION_DISPLAY_IMAGES_SWIPE = "android.intent.action.DISPLAY_IMAGES_SWIPE";
    ...
    public static Intent makeIntent(String directoryPathname, int position) {
        return new Intent(ACTION_DISPLAY_IMAGES_SWIPE).setDataAndType(Uri.parse(directoryPathname),
                "image/*").putExtra(ViewPagerActivity.CURRENT_IMAGE_POSITION, position);
    }
    ...
    public static class ImageDetailFragment extends Fragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mImageFilePath = getArguments() != null ? getArguments().getString("file") : null;
        }
        ...
        public View onCreateView(LayoutInflater inflater,
            ...
            View rootView = inflater.inflate(R.layout.fragment_collection_detail, container, false);

            // Use the ImageLoader to load and display the bitmap
            ((ViewPagerActivity) getActivity()).getImageLoader()
    ...
    private class ImagePagerAdapter extends FragmentStatePagerAdapter {
         ...
         */
        public ImagePagerAdapter(FragmentManager fm, File[] files) {
            super(fm);
            Log.v(TAG, "ImagePagerAdapter constructor()");
            mBitmapFiles = new ArrayList<>(Arrays.asList(files));
        }
